  ...
  return (
    <>
      ...
      <section className="section" style={{ background: "var(--gray-50)" }}>
        <div className="section-inner">
          <div className="text-center">
            <div className="section-chip chip-teal">How it works</div>
            <h2 className="section-title">Up and running in minutes</h2>
            <p className="section-desc">Whether you're consuming or publishing APIs, Flowra makes it effortless.</p>
          </div>
          <div style={{ marginTop: "48px" }}>
            <div style={{ display: "flex", gap: "16px", marginBottom: "32px", flexWrap: "wrap" }}>
              <div style={{ padding: "8px 20px", borderRadius: "100px", background: "var(--blue)", color: "#fff", fontSize: "14px", fontWeight: "600", cursor: "default" }}>For Consumers</div>
              <div style={{ padding: "8px 20px", borderRadius: "100px", background: "var(--gray-100)", color: "var(--gray-700)", fontSize: "14px", fontWeight: "500", cursor: "default" }}>For Providers</div>
            </div>
            <div className="steps-grid" style={{ background: "#fff", borderRadius: "var(--radius-lg)", border: "1px solid var(--gray-200)" }}>
              {[
                { n: "1", title: "Create account", desc: "Sign up free as a Consumer in under 30 seconds." },
                { n: "2", title: "Browse APIs", desc: "Explore the marketplace and find the perfect API." },
                { n: "3", title: "Subscribe to a plan", desc: "Choose free or premium. Pay securely via Razorpay." },
                { n: "4", title: "Integrate & build", desc: "Copy your API key and start making requests." },
              ].map((s, i) => (
      ...
      <section className="cta-section">
        <div className="cta-inner">
          ...
          <div className="cta-btns">
            <button className="btn-white" onClick={() => {}}>Start for free</button>
            <button className="btn-white-outline" onClick={() => {}}>Schedule a demo</button>
          </div>
        </div>
      </section>
    </>
...
function PricingPage({ openModal }) {
  const plans = [
    { name: "Free", price: "0", desc: "Perfect for hobby projects and exploring the marketplace.", features: ["Up to 1,000 API calls/month", "Access to free tier APIs", "Basic analytics", "Community support", "1 API key"], cta: "Get started free", style: "btn-pricing-outline", featured: false },
    { name: "Pro", price: "999", desc: "For developers and small teams building production apps.", features: ["100,000 API calls/month", "Access to all premium APIs", "Advanced analytics & charts", "Priority email support", "10 API keys", "Webhook notifications"], cta: "Start Pro trial", style: "btn-pricing-filled", featured: true },
    { name: "Enterprise", price: "4,999", desc: "For businesses that need scale, compliance, and SLAs.", features: ["Unlimited API calls", "Dedicated support manager", "Custom SLA & uptime guarantee", "SSO & team management", "Unlimited API keys", "Custom integrations", "Invoice billing"], cta: "Contact sales", style: "btn-pricing-outline", featured: false },
  ];
  return (
    <div>
      <div className="section" style={{ background: "var(--gray-50)", paddingBottom: "40px" }}>
      ...
      <section className="section" style={{ paddingTop: "48px" }}>
        <div className="section-inner">
          ...
          <div style={{ textAlign: "center", marginTop: "40px", padding: "24px", background: "var(--gray-50)", borderRadius: "var(--radius-lg)", border: "1px solid var(--gray-200)" }}>
            ...
            <div style={{ fontSize: "14px", color: "var(--gray-600)" }}>Publishing APIs is <strong>free</strong>. Flowra takes a small 10% revenue share only when you earn. <button className="modal-footer-link" onClick={() => openModal("register")}>Become a provider →</button></div>
          </div>
        </div>
      </section>
    </div>
        ...
        <div className="section-inner">
          ...
          <div className="about-values">
            {[
              ...
              { icon: "💸", title: "Fair monetization", desc: "Providers deserve to earn from their work. Our 90/10 revenue split is the most generous in the market." },
            ].map((v, i) => (
      ...
      <section className="section" style={{ background: "var(--gray-50)" }}>
        <div className="section-inner text-center">
          ...
          <div className="about-team">
            {[
              { init: "RK", name: "Rohit Kumar", role: "Founder & CEO", color: "#1a73e8" },
